...
class ScoreGet:
    def __init__(self):
        ...
        self.api_key = "Your api Key from cricpy"
...
if __name__ == "__main__":
    ...
    account_sid = "Your account id from twilio"
    auth_token = "Your auth token from twilio"
    client = Client(account_sid, auth_token)
    message = client.messages.create( body=whatsapp_message, from_='whatsapp:+14155238886', to='whatsapp:+91 Your Whatsapp Number' )